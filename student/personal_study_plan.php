...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .btn-continue:hover { transform: translateY(-2px); box-shadow: 0 12px 28px rgba(102,126,234,0.5); }
        ...
        .subject-name { font-size: 15px; font-weight: 700; color: #333; }
        ...
        .btn-edit:hover { background: #667eea; color: white; border-color: #667eea; }
        .btn-delete { background: #ffebee; color: #d32f2f; border: 1px solid #d32f2f; }
        ...
        .confidence-label { font-size: 12px; color: #999; font-weight: 500; }
        ...
        .btn-primary {
            flex: 1; padding: 12px;
            background: white; border: 2px solid #e0e0e0; color: #333;
        ...
        .btn-modal-save {
            ...
            font-size: 14px; font-weight: 600; transition: all 0.3s ease; text-transform: uppercase;
        }
        .btn-modal-save:hover { transform: translateY(-2px); }
        .btn-modal-cancel {
        ...
        @media (max-width: 640px) {
            ...
            .btn-back, .btn-continue { flex: 1; justify-content: center; }
        }
    </style>
</head>
<body>
...
<div class="main-container">
    ...
    <div class="content">
        ...
        <!-- Page Header with Back + Continue buttons -->
        <div class="page-header">
            ...
            <div class="header-btns">
                <a href="class_timetable.php" class="btn-back">
                    Class Timetable
                </a>
                <a href="timetable.php" class="btn-continue">
                    AI Study Plan Timetable
                </a>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <input type="range" class="slider" id="newConfidence" name="confidence_level"
                       min="0" max="100" value="50" oninput="updateNewConfidence()">
            </div>
            ...
            <div class="button-group">
                <button type="button" class="btn-primary" onclick="addSubject()">
                     Add Subject
                </button>
            </div>
        </div>
    ...
    <div class="modal-content">
        ...
        <form id="editForm" method="POST" action="personal_study_plan.php">
            ...
            <div class="form-group">
                ...
                <input type="range" class="slider" id="editConfidence" name="confidence_level"
                       min="0" max="100" value="50" oninput="updateEditConfidence()">
            </div>
...
<script>
    ...
    function addSubject() {
        ...
        form.method = 'POST'; form.action = 'personal_study_plan.php';
        form.innerHTML = `
            <input type="hidden" name="action" value="add_subject">
            <input type="hidden" name="subject" value="${subject}">
            <input type="hidden" name="confidence_level" value="${confidence}">
        `;
    ...
    function editSubject(planId, subject, confidence) {
        ...
        slider.style.setProperty('--value', confidence + '%');
    ...
    window.addEventListener('DOMContentLoaded', () => { updateNewConfidence(); });
</script>
</body>
</html>